...
{
    public class OffensiveRatingStatsProviderTests
    {
        [Fact]
        public async Task GetStatsReturnsStatsFromWebProvider()
        {
            ...
            {
                BaseAddress = new Uri("https://www.teamrankings.com/nba/stat/offensive-efficiency")
            };
            var statsProvider = new OffensiveRatingStatsProvider(httpClient);

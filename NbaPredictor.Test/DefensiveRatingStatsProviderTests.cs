...
{
    public class DefensiveRatingStatsProviderTests
    {
        [Fact]
        public async Task GetStatsReturnsStatsFromWebProvider()
        {
            ...
            {
                BaseAddress = new Uri("https://www.teamrankings.com/nba/stat/defensive-efficiency")
            };
            var statsProvider = new DefensiveRatingStatsProvider(httpClient);
